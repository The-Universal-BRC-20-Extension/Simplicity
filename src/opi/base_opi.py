...
class BaseProcessor(ABC):
    ...
    def process_op(self, op_data: Dict[str, Any], tx_info: Dict[str, Any]) -> Tuple[ProcessingResult, State]:
        ...
        This method MUST NOT mutate any state directly.
        It MUST return a ProcessingResult indicating success or failure,
        and a State object describing the desired state changes.
        """
        pass
