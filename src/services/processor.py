...
class BRC20Processor:
    ...
    def process_multi_transfer(
        ...
        if not structure_validation.is_valid:
            ...
            return self._create_processing_result(tx_info["txid"], structure_validation, is_multi=True, _op_data=op_data), [], []
        ...
        if not meta_validation.is_valid:
            ...
            return self._create_processing_result(tx_info["txid"], meta_validation, is_multi=True, _op_data=op_data), [], []
        ...
        return self._create_processing_result(
            ...
            final_result,
            is_multi=True,
            _op_data={"tick": ticker, "amt": total_amount}
        ), [], []
